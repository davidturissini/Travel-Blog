...
module Adventureblog
  class Application < Rails::Application
    ...
    config.autoload_paths += %W(#{config.root}/lib/ #{config.root}/lib/class #{config.root}/lib/modules #{config.root}/lib/modules/realm_account_providers)
    ...
    config.filter_parameters += [:password, :salt]
